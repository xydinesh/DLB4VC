...
DimacsBuilder::DimacsBuilder(void)
{
}

DimacsBuilder::DimacsBuilder(const char *f) : Builder(f)
{
...
void DimacsBuilder::split(const string &s, vector<int> &v)
{
	string tmp;
	int n;
...
Graph* DimacsBuilder::build_graph()
{
